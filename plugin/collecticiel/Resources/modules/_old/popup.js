...
$(document).ready(function() {
  ...
  $('.td_action').each(function() {
    ...
    if (adminInnova == true) {
      if (isValidate == false || senderId != docDropUserId) {
        selector = '#delete_' + documentId
      } else if (isValidate == true && commentLength == 0 && senderId == docDropUserId) {
        selector = '#cancel_' + documentId
      } else {
        selector = '#lock_' + documentId
      }
  ...
  $('.inputReturnReceipt').on('click', function() {
  ...
  $('#modal_confirm').on('click', function() {
    selector = '#document_id_' + $(this).attr('data-document_id') // Extract info from data-* attributes
  ...
  // InnovaERV
  // Ajout pour le traitement du clic sur le bouton "Oui, valider"
  $('.modal_transmit_confirm').on('click', function() {
    selector = '#document_id_' + $(this).attr('data-document_id') // Extract info from data-* attributes
    var documentId = $(this).attr('data-document_id')
    var button = document.getElementById('delete_' + documentId)
  ...
  $('#choix3').on('click', function() {
    document.getElementById('modal_confirm_return_receipt').disabled = false
  })
  $('#choix4').on('click', function() {
    document.getElementById('modal_confirm_return_receipt').disabled = false
  })
  $('#choix5').on('click', function() {
    document.getElementById('modal_confirm_return_receipt').disabled = false
  })
  ...
  $('.modal_confirm_notation_record').on('click', function(event) {
    ...
    var appreciation, commentText, qualityText, note
    // Récupération de l'id du document
    var documentId = $(this).attr('data-document_id')
    ...
    if (evaluationType === 'notation') {
      ...
      commentText = ''
      qualityText = ''
      note = document.getElementById('innova_collecticiel_notation_form_note_' + documentId).value
    }

    if (evaluationType === 'ratingScale') {
      // Récupération de la valeur de l'appréciation
      appreciation = document.getElementById('innova_collecticiel_notation_form_scaleName_' + documentId).value
      commentText = ''
      qualityText = ''
      note = 0
    }
    ...
    // Récupération de l'id du document
    documentId = $(this).attr('data-document_id')
  ...
  $('.document_validate').on('click', function() {})
  ...
  $('#modal_confirm-cancel').on('click', function(event) {
    ...
    selector = '#delete_' + docId
    $(selector).css({
      'display': 'inline'
    })

    // Je n'affiche plus l'ancien sélecteur
    selector = '#cancel_' + docId
    $(selector).css({
      'display': 'none'
    })
  ...
  $('#document_id_0').on('click', function() {
    if ($(this).is(':checked')) {
  ...
  $('.validation_edit_common').on('click', function() {
