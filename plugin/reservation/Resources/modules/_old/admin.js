  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.error == 'empty_string') {
        modal.confirmContainer(t('error_'), t('error.empty_input'))
      } else if (data.error == 'resource_type_exists') {
        modal.confirmContainer(t('error_'), t('error.resource_type_already_exists'))
      } else {
...
$('body')
  ...
  .on('click', '.modify-resource-type', function () {
    ...
    modal.displayForm(routing, displayResourceTypeChanges, function () {}, 'form-resource')
  })
  .on('click', '.add-new-resource', function () {
    ...
    modal.displayForm(routing, displayNewResource, initResourceForm, 'form-resource')
  })
  ...
  .on('click', 'a[data-resource-id]', function (e) {
    ...
    modal.displayForm(routing, displayModificationResource, initResourceForm, 'form-resource')
  })
