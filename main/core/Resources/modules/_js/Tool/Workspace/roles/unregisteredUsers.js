...
parameters.route.normal = {'route': 'claro_workspace_unregistered_user_list', 'parameters': {'workspace': window.workspaceId, 'order': window.order }}
parameters.route.search = {'route': 'claro_workspace_unregistered_user_list_search', 'parameters': {'workspace': window.workspaceId, 'order': window.order }}
