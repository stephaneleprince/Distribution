    ...
    success: function (modalContent) {
      ...
      function updateIdsArray (type) {
        switch (type) {
          ...
          case 'workspace':
            ...
            for (let key in workspaceFilters) {
        ...
        switch (filterType) {
          ...
          case 'workspace':
            ...
            if (thirdFilterValue === 'none') {
              ...
              let roleId = parseInt(thirdFilterValue)
      ...
      modalElement.on('click', '.picker-user-chk', function () {
        ...
        if (userPicker.multiple === 'multiple') {
          ...
          let firstName = $(this).data('user-first-name')
          let lastName = $(this).data('user-last-name')
