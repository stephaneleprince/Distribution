...
$('#all-my-contacts-content-body').on('click', '.contact-additional-action', function () {
...
$('#all-visible-users-content-body').on('click', '.contact-additional-action', function () {
  var child = $(this).children('.contact-action')
  var url = child.data('url')
  window.location = url
})
...
$('.category-content-body').on('click', '.contact-additional-action', function () {
  var child = $(this).children('.contact-action')
  var url = child.data('url')
  window.location = url
})
