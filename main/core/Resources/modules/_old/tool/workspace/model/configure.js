...
/* global Translator */
/* global Twig */
/* global GroupModelRow */
/* global UserModelRow */
/* global ModelTab */
/* global ModelResource */

var rootId = $('#data').attr('data-root-id')
let modelId = $('#data').attr('data-model-id')

resourceManager.createPicker(
  'copy',
  {
    ...
    success: function(data) {
      modal.confirmContainer(Translator.trans('add_tab', {}, 'platform'), data)
        .on('click', '.btn-primary', function() {
          ...
          let route = Routing.generate('ws_model_homeTabs_model_link', {'model': modelId})
